...
1. Statistical properties for deterministic dynamical systems
2. Stochastic differential equations on homogenization problem

## Publications

1. Zhenxin Liu, **Zhe Wang\***. Wasserstein convergence rates in the invariance principle for deterministic dynamical systems. **Ergodic Theory and Dynamical Systems**, 44 (2024), 1172-1191.
2. Zhenxin Liu, **Zhe Wang\***. Wasserstein convergence rates in the invariance principle for sequential dynamical systems. **Nonlinearity**, 37 (2024), 125019, 27pp.
...
1. Nicholas Fleming-Vázquez, **Zhe Wang**. Rate of Convergence in the weak invariance principle for sequential dynamical systems. Preprint.

## Grants

1. The Young Scientists Fund of the National Natural Science Foundation of China (Grant Number: 12501239)

## Academic Services

1. MathSciNet Reviewer
